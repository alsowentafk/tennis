...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers(HttpMethod.PUT, "/api/user/updateUser").hasRole("USER")
                .antMatchers(HttpMethod.POST, "/api/tournamentUser/regUserOnTournament").hasRole("USER")
                ...
                .antMatchers(HttpMethod.POST, "/api/tournament/addTournament").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/tournament/updateTournament").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/user/findAll").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/tournamentUser/getAll").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/tournamentUser/getRequestById").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/api/tournamentUser/delete").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/tournamentUser/confirm").hasRole("ADMIN")
