...
export class UserService {
  ...
  async registerNewUser(user: User, fileToUpload: File) {
    const endpoint = 'http://176.114.8.113:8080/api/user/registerNewUser';
  ...
  async findUserByEmail(email: string): Promise<User> {
    ...
    const endpoint = 'http://176.114.8.113:8080/api/user/getUser';
  ...
  async updateUser(user: User, fileToUpload: File) {
    const endpoint = 'http://176.114.8.113:8080/api/user/updateUser';
  ...
  async findUserById(id: string): Promise<User> {
    const endpoint = 'http://176.114.8.113:8080/api/user/getUserById';
  ...
  async findAllPlayersByTournament(id: string): Promise<User[]> {
    ...
    const endpoint = 'http://176.114.8.113:8080/api/tournamentUser/findAllPlayersFromTournament';
    return await this.httpClient.get<User[]>(endpoint, this.httpOptionsUser).toPromise();
  }
  async findAllPlayers(): Promise<User[]> {
    const endpoint = 'http://176.114.8.113:8080/api/tournamentUser/findAllPlayers';
    return await this.httpClient.get<User[]>(endpoint).toPromise();
  }
  async findAll(): Promise<User[]> {
    const endpoint = 'http://176.114.8.113:8080/api/user/findAll';
    return await this.httpClient.get<User[]>(endpoint, this.httpOptionsAdmin).toPromise();
  }
  async delete(id: string){
    const endpoint = 'http://176.114.8.113:8080/api/user/delete';
